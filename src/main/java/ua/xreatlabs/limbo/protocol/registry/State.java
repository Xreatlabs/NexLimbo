...
package ua.xreatlabs.limbo.protocol.registry;

import ua.xreatlabs.limbo.protocol.Packet;
import ua.xreatlabs.limbo.protocol.packets.PacketHandshake;
import ua.xreatlabs.limbo.protocol.packets.login.*;
import ua.xreatlabs.limbo.protocol.packets.play.*;
import ua.xreatlabs.limbo.protocol.packets.configuration.*;
...
import static ua.xreatlabs.limbo.protocol.registry.Version.*;
